...
**TODO:**  
- Validate
- Check submission format (notebook - qmd with executed content is not possible??)
- Carefully compare with group-work docs of previous coursese
- Presentation slides (PDF) and notebook (??) must be submitted the day before presentation until 20.00 (to {{< meta instructor.email >}})
