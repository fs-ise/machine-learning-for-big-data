...
Submit your three ranked project preferences by **{{< var group_work.application_deadline >}}**.
...
- Presentation date: **{{< var group_work.presentation_date >}}**
...
- Final report deadline: **{{< var group_work.submission_date >}}**
- Submit the final text document via the [Canvas assignment]({{< var group_work.submission_url >}}).
...
Submit all required files via the [Canvas assignment]({{< var group_work.submission_url >}}).
