...
## Key figures: concepts map directly to R
...
- mode → category with the highest count
...
```{r}
#| label: key-figures-concepts-map-directly-to-r-table
#| echo: true
...
## Numerical summary: `profit_margin`

::: columns

::: {.column width="38%"}

- `summary()` gives a compact overview.
- **Mean** describes the center.
- **Standard deviation** describes spread around the mean.
- **Quantiles** mark positions in the ordered values.
...
```{r}
#| label: numerical-summary-profit-margin
#| echo: true

summary(firm_data_df$profit_margin)

round(mean(firm_data_df$profit_margin), 2)
round(sd(firm_data_df$profit_margin), 2)

quantile(
  firm_data_df$profit_margin,
