...
title-slide-image: "../images/cover_slide/deployment.png"
...
::: {.column width="60%"}
**Business-analytics value configuration**

- **Technical resources:** data, platforms, and analytical tools
- **Human resources:** analytical and business expertise
- **Management capabilities:** coordination and strategic alignment
- **Complementary conditions:** data quality and organizational culture
- **Context:** external pressure and other firm conditions

Together, these resources and capabilities contribute to **firm performance**.
:::
:::
