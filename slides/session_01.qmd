...
- **Use** RStudio and Quarto to import, inspect, and analyze data in a reproducible analytical workflow.
:::
...
```{python}
#| label: the-exponential-growth-of-data-import-matplotlib-pyplot-as-pl
#| echo: false

from sys import path

path.insert(0, "../images")
from _global_data_growth import plot_global_data_growth

plot_global_data_growth()
```
...
| Zettabyte (ZB) | 1,000 EB | $\approx 1$ trillion gigabytes; global data creation scale |
...
::: aside
Reinsel, D., Gantz, J., & Rydning, J. (2018). *The Digitization of the World: From Edge to Core*. IDC White Paper #US44413318, sponsored by Seagate. <https://www.seagate.com/files/www-content/our-story/trends/files/dataage-idc-report-final.pdf>
...
CBRE Research. (2024). *European Data Centres Overview*. <https://www.cbre.com/insights/reports/european-data-centres-overview>
:::
...
- $\approx$ **7.17B decisions / day** at peak capacity
...
- $83{,}000 \times 86{,}400 = 7{,}171{,}200{,}000$ theoretical peak transaction decisions per day.
...
{{< iconify fluent:people-chat-24-regular >}} **Discuss with your neighbor (5 min)**
...
- Only a **handful of datasets** exhibited all characteristics they examined.
- Even **volume and variety were not necessary**: some accepted Big Data datasets were neither exceptionally large nor diverse.
- The clearest distinction was **velocity and exhaustivity**: Big Data tend to capture **continuous or rapidly generated data across an entire system**, rather than slower, sampled observations.
...
## Practical exercise: A first Quarto report

**Base task**

- Create a Quarto document called `report.qmd`.
- Select a suitable dataset from <a href="https://www.kaggle.com/datasets" target=_blank>Kaggle</a> and download it as CSV.
- Create an R codeblock to import the CSV and display the first rows using `head()`.
- Add a short **analytical question** that could be investigated using the dataset.
...
Consult the documentation of [Quarto](https://quarto.org/docs/) or the [Tidyverse](https://tidyverse.org/packages/) and implement additional feature(s) of your choice:

- Create a scatterplot with `ggplot2` and hide the code in the rendered document.
- Add a citation and a bibliography.
- Render the document as **PDF**.
:::

::: {.layout-cell}
**Take-home exercise: Develop a potential group project topic**

Use your document as a starting point for a **potential group project topic**.

- Formulate a **business or analytical question**.
- Describe the **business context** and why the question is relevant.
- Identify the **data and variables** that would be needed.
- Describe suitable **analytical methods**.
- Explain which **business decisions** the analysis could support.
:::
...
In the practical part, we learned how to:

- create and structure a Quarto (`.qmd`) document,
- import and inspect data with R,
- combine text, code, and analytical output in one document,
- and render the analysis as HTML or PDF.
...
Before the break, please install the tidyverse package for the exercises:

```r
install.packages("tidyverse")
```

{{< survey session_01 slide >}}
