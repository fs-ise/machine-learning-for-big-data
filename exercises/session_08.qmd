...
For this exercise, the course repository should contain a prepared subset ([data/imdb_reviews_sample.csv](data/imdb_reviews_sample.csv)) with the following columns:
