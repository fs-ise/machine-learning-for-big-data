---
title: "Notes: Session 8: ML for Non-Tabular Data (Text)"
session_id: session-08
format: html
---

TODO: after the Big-Data/Architectures slides were removed (compared to analytics-and-big-data), this session may need to be expanded.

| Time (min) | Duration | Topic | Additional materials |
|------------|----------|-------|----------------------|
| 0–40       | 40       | Text analytics | |
