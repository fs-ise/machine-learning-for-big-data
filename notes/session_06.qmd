...
- **Primarily**: Algorithms or analytical models with few variables (Modellsparsamkeit????)
...
The authoritative exercise is `../exercises/session_06.qmd`. It remains an imported outline at this stage; do not fill the missing practical detail until the dedicated R/content-review stage.
