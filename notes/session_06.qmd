---
title: "Notes: Session 6: Machine Learning Foundations: Workflow"
...
- Part 2: make sure the `step_normalize()` is called before the `step_dummy()` (otherwise, dummy variables are interpreted as numeric and then normalized).